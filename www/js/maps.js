...
function getPlaces(latitude, longitude) {
    ...
    Map = new google.maps.Map(document.getElementById('test-map-container'), mapOptions);
    Infowindow = new google.maps.InfoWindow();
    createMarkerForHome(latLong);
...
function createMarkerForHome(place) {
    var marker = new google.maps.Marker({
        position: place,
        map: Map,
